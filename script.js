  ...
  // ----- DEFAULT PROJECTS (used as fallback and reset) -----
      const DEFAULT_PROJECTS = [
        ...
        },
        {
          ...
          problem: "Problem ZED Is Solving

Many people don’t understand their health symptoms or body signals, and getting quick medical guidance is often slow, expensive, or inaccessible. People may ignore symptoms, panic unnecessarily, or search unreliable information online.

ZED solves this problem by providing an AI-powered health assistant that helps users analyze symptoms, track vital signs, and receive instant health insights, allowing them to make informed decisions about their health earlier and more easily. 🩺📱",
          tech: ["React", "TypeScript", "Fastify", "MongoDB", "Socket.io"],
          architecture: "User → Encrypt → Backend → AI Analysis → Encrypted Storage → User Dashboard

This gives a full end-to-end encrypted health monitoring and AI analysis system.",
          category: "fullstack",
